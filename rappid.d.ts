...
declare module 'jointjs' {
    ...
    export namespace dia {
        ...
        export namespace Graph {
            ...
            interface ConstructTreeConfig {
                ...
                makeElement: (node: ConstructTreeNode) => dia.Element;
    ...
    export namespace ui {
        ...
        class Clipboard extends Backbone.Collection<Backbone.Model> {
             ...
             */
            copyElements(selection: Backbone.Collection<dia.Cell>, graph: dia.Graph, opt?: Clipboard.Options): Array<dia.Cell>;

            /**
             * Same logic as per `copyElements`, but elements are removed from the graph
             */
            cutElements(selection: Backbone.Collection<dia.Cell>, graph: dia.Graph, opt?: Clipboard.Options): Array<dia.Cell>;
             ...
             */
            pasteCells(graph: dia.Graph, opt?: Clipboard.Options): Array<dia.Cell>;
    ...
    export namespace format {
        ...
        export function toCanvas(paper: dia.Paper, callback: (canvas: HTMLCanvasElement) => void, opt?: dia.Paper.CanvasExportOptions): void;
